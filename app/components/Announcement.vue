  ...
  <Transition name="announcement-banner">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <button
          @click="close"
          class="flex-shrink-0 w-8 h-8 flex items-center justify-center hover:bg-gray-400/30 dark:hover:bg-gray-500/30 rounded-lg transition-colors text-gray-800 dark:text-white"
          title="关闭公告"
        >
